    ...
    <div class="nav-box">
      <div class="nav">
        <ul class="nav-ul">
          ...
          <li><a href="./passenger.html" class="passenger"><span>乘机人管理</span></a></li>
          <li><a href="./ticket.html" class="ticket"><span>机票管理</span></a></li>
          <li><a href="./deli.html" class="deli"><span>业务员管理</span></a></li>
        </ul>
      </div>
    </div>
  </div>
