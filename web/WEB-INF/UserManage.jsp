...
<div class="main-body">
    <div class="my-table-area" style="display: inline-block; left:200px; position: absolute;">
        <div class="search-area">
            ...
            <div class="sa-ele">
                ...
                <select name="authority" value="" class="se-con">
            ...
            <div class="sa-ele">
                ...
                <button class="add-action bounce-in-down-add">添加用户</button>
            </div>
        </div>
        <br/>
    ...
    <div class="pop-edit">
        ...
        <div id="dialog-edit" class="animated">
            ...
            <form action="" method="post" id="edit-user-form" class="edit-form">
                <ul class="edit-infos">
                    <li class="text"><label><span>用户名:</span><input type="text" name="pass_id" value=""
                                                                    class="ipt ipt-id"/></label></li>
                    <li class="text"><label><span>密码:</span><input type="text" name="pass_name" value=""
                                                                   class="ipt ipt-flight"/></label></li>
                    <li class="text"><label><span>权限:</span><select name="authority" value="" class="ipt ipt-authority">
                        <option value="0">普通用户</option>
                        <option value="1">管理员</option>
                    </select></label></li>
    ...
    <div class="pop-edit">
        ...
        <div id="dialog-add" class="animated">
            ...
            <form action="" method="post" id="add-user-form" class="add-form">
                <ul class="edit-infos">
                    <li class="text"><label><span>用户名:</span><input type="text" name="pass_id" value=""
                                                                    class="ipt ipt-id"/></label></li>
                    <li class="text"><label><span>密码:</span><input type="text" name="pass_name" value=""
