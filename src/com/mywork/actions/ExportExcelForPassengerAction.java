...
public class ExportExcelForPassengerAction {
	...
	public String execute() throws IOException{
		...
		HSSFSheet sheet = wb.createSheet("乘机人");
		...
		try{  
		    ...
		    cacheDir.mkdirs();
			FileOutputStream fout = new FileOutputStream(path+"\\乘机人.xls");  
            wb.write(fout);  
            fout.close();
            wb.close();
        }  
		...
		//解决下载名称设置为中文时出现的乱码问题，当前"passenger.xls"情况无需这样
