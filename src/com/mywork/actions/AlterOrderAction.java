...
public class AlterOrderAction {
	...
	public String execute() throws IOException{
		...
		orderDao.openDB();
		String sql="update t_order set flight_id='"+flight_id+"',pass_id='"+pass_id+
				"',deli_id='"+deli_id+"',price_orig='"+price_orig+"',price_purc='"+price_purc+
